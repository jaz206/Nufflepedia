...
export default async function SecuenciaPartidoPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Secuencia de Partido</h1>
        <p className="mt-2 text-zinc-500">
          ...
          ninguno. Para el registro en vivo de touchdowns, faltas y turnos, llega más
          adelante el Asistente de Partido en <code>/arena</code>.
        </p>
      </div>
